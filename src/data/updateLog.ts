...
export const updates: UpdateEntry[] = [
  ...
  },
  {
    ...
    items: [
      {
        title: '🌙 全局深色模式（含调色优化）',
        description: '新增全局深色 / 浅色 / 跟随系统三档主题切换：首页右上角一键切换、设置页"外观主题"卡片精细选择，偏好持久化到本地，首屏防闪烁。暗色色板按主流规范重新调校：背景 #14171f 偏蓝灰深色（非纯黑，避免眩光），卡片做 +4% 亮度的层级提升 #1c2029，主文本 #dde2ea / 辅助文本 #a0a8b6 对比度均 ≥ 4.5:1 通过 WCAG AA；同时对历史硬编码的 gray-800 / blue-50 / white 等颜色做暗色兜底映射，保证全站卡片、文本、彩色强调在暗色下都清晰可读。',
        type: 'feature',
      },
    ],
  },
