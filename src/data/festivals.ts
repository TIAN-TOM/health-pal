...
// 农历节日（2025年公历对照，每年需更新）
// 注意：这些是2025年的近似日期，农历节日每年公历日期会变化
export const lunarFestivals2025: { [key: string]: string } = {
  '01-07': '腊八',
  '01-23': '小年',
  '01-28': '除夕',
  '01-29': '春节',
...
export const getFestivalForDate = (date: Date): string[] => {
  ...
  // 检查农历节日（2025年）
  if (lunarFestivals2025[monthDay]) {
    festivals.push(lunarFestivals2025[monthDay]);
  }
