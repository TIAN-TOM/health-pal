...
export const manualSections: ManualSection[] = [
  ...
  },
  {
    ...
    title: '主界面导航',
    content: '主界面采用简洁的卡片式设计，包含每日签到、健康记录功能、呼吸训练、语音记录、解压小游戏和个人设置入口。每个功能都配有直观的图标和描述，让您能够快速找到所需的功能。使用手册入口位于主页面便于随时查阅。',
    section: '入门指南',
    order_index: 3,
    icon: 'Layout'
  },
  ...
  // 基础功能
  {
    id: 'basic-1',
    title: '每日签到功能',
    content: '每日签到是建立健康习惯的核心功能。您可以记录当天的整体状态、心情评分（1-5分）、特殊事件或感受。坚持每日签到能够帮助您更好地了解自己的健康规律，建立连续的健康追踪记录。',
    section: '基础功能',
    order_index: 10,
    icon: 'Calendar'
  },
  ...
  },
  {
    id: 'basic-3',
    title: '呼吸训练功能',
    content: '呼吸训练功能提供多种呼吸模式，包括4-7-8放松法、平衡呼吸和深度放松等。通过可视化圆圈引导和背景音乐，帮助您进行正确的深呼吸练习，有效缓解压力、改善睡眠质量并提升专注力。',
    section: '基础功能',
    order_index: 12,
    icon: 'Wind'
  },
  {
    id: 'basic-4',
    title: '语音记录功能',
    content: '语音记录功能让您能够快速录制健康相关的语音笔记。当您无法方便输入文字时，可以使用语音记录功能快速保存重要的健康信息、症状描述或医生建议。',
    section: '基础功能',
    order_index: 13,
    icon: 'Mic'
  },
  {
    id: 'basic-5',
    title: '解压小游戏',
    content: '内置多种轻松有趣的小游戏，包括"小鸟会飞"、智能五子棋和打砖块游戏。游戏支持音效开关，帮助您在记录健康数据的间隙放松心情，缓解压力。游戏难度经过优化，让您能够轻松获得成就感。',
    section: '基础功能',
    order_index: 14,
    icon: 'Gamepad2'
  },
