...
export const GAMES: GameMeta[] = [
  ...
  buildGameMeta({
    ...
    strategy: {
      heading: '💣 Q版泡泡堂 · Bomb It 风格扩展',
      bullets: [
        '4 个角色：兔奇(+速度) / 猫蛋(+炸弹) / 熊大(+HP) / 狐狸(+范围)',
        '3 种模式：街机闯关(15关含Boss) / 竞技对战(vs 3 CPU) / 生存挑战',
        '9 种道具：💣📈👟⚡✨📡🛡️❤️❄️ — 含遥控引爆 / 穿透火焰 / 冻结全场',
        '4 种主题地图：森林 / 沙滩(流沙) / 冰原(滑动) / 火山(随机喷火)',
        '键盘：方向键/WASD 移动，空格放炸弹，R 遥控引爆',
        '通关 / 破纪录奖励真实积分（每日上限 100）',
      ],
      highlight: '💥 经典俯视角解压玩法 · Bomb It 4 风格 1:1 复刻',
    },
  }),
];
