      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <Tabs defaultValue="checkin" className="space-y-6">
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="list">历史数据</TabsTrigger>
            <TabsTrigger value="checkin-calendar">打卡日历</TabsTrigger>
          </TabsList>

          <TabsContent value="checkin">
            <CheckinSection todayCheckin={todayCheckin} onCheckinSuccess={setTodayCheckin} onReloadHistory={loadCheckinHistory} />
          </TabsContent>
          ...
          <TabsContent value="checkin-calendar">
            <CheckinCalendarSection checkinDates={checkinDates} selectedDate={selectedDate} onDateSelect={handleDateSelect} />
          </TabsContent>
        </Tabs>
      </div>
    </div>;
